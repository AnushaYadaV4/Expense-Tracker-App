    ...
    try {
      ...
      if (isLogin) {
        ...
        sendRequest(
          {
            request: "post",
            url: "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyDADt-jvOGYxraqe3BThGHnaQjwouzxhR0",
            body: authObj,
        ...
        if (
          ...
          sendRequest(
            {
              request: "post",
              url: "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyDADt-jvOGYxraqe3BThGHnaQjwouzxhR0",
              body: authObj,
              header: { "Content-Type": "application/json" },
            },
            resData
